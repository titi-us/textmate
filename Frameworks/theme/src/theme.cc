...
static theme_t::decomposed_style_t::color_info_t read_color (std::string const& str_color );
static void get_set_key_path(plist::dictionary_t const& plist, std::string const& setting, theme_t::decomposed_style_t::color_info_t&  color) {
	std::string temp_str;
...
{
	static struct { std::string name; theme_t::decomposed_style_t::color_info_t decomposed_style_t::*field; } const colorKeys[] =
	{
...
static theme_t::decomposed_style_t::color_info_t read_color (std::string const& str_color ) 
{
	...
	return theme_t::decomposed_style_t::color_info_t::color_info_t(col[R]/255.0, col[G]/255.0, col[B]/255.0, col[A]/255.0);
}

static void alpha_blend (theme_t::decomposed_style_t::color_info_t& lhs, theme_t::decomposed_style_t::color_info_t const& rhs)
{
	if (rhs.is_blank()) {
		return;
	}
